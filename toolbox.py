...
class ReLU(Function):
    ...
    def backward(self, dLdf):
        ...
        d_relu = Tensor(self.t.data>0)
        grad = d_relu.data*dLdf
        self.t.backward(grad)
        pass
...
class Exp(Function):
    ...
    def backward(self, dLdf):
        ...
        self.t.backward(self.expt*dLdf)
        pass
...
class Log(Function):
    ...
    def backward(self, dLdf):
        ...
        self.t.backward((1/(self.t.data))*dLdf)
        pass
...
class Sum(Function):
    ...
    def backward(self, dLdf):
        ...
        grad = np.ones(self.t.data.shape)*dLdf
        self.t.backward(grad)
        pass
...
class Mean(Function):
    ...
    def backward(self, dLdf):
        ...
        grad = (self.t.data)/(self.t.data.size)*dLdf
        self.t.backward(grad)
        pass
...
class GetItem(Function):
    ...
    def backward(self, dLdf):
        ...
        grad= np.zeros(self.t.data.shape)
        grad[self.index] = 1
        grad = grad * dLdf
        self.t.backward(grad)
        pass
